...
function Card({ element, setSelectedid, setOpendetails }) {

  return (
    <div className='card' onClick={() => { setSelectedid(element.id); setOpendetails(true) }} style={{ display: "flex", flexDirection: "column", position: "relative", margin: "auto", boxShadow: "rgba(0, 0, 0, 0.1) 0px 4px 6px -1px,rgba(0, 0, 0, 0.06) 0px 2px 4px -1px", borderRadius: "15px", height: "100%", cursor: "pointer" }}>
